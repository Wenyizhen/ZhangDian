...
/*! 指引线的文字字体大小 */
static CGFloat const nameTextFont = 11;
/*! 指引线的宽度 */
...
-(void)addLineAndnumber:(UIColor *)color
    ...
    NSString *number = [NSString stringWithFormat:@"%@ %@",model.name,model.number];
    CGSize numberSize = [number sizeWithAttributes:@{
                                                     NSFontAttributeName:[UIFont systemFontOfSize:nameTextFont]
                                                     }];
    
    // 文字size
    CGSize textSize = [@" " sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:nameTextFont]}];
    // 设置折点
...
//        numberStartY = lineEndPointY - numberSize.height;
    ...
    // 10.画指引线上的数字
     [number drawAtPoint:CGPointMake(numberStartX, numberStartY) withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10.0],NSForegroundColorAttributeName:textColor}];
...
//     11.1设置段落风格
    ...
    [@"  " drawInRect:CGRectMake(textStartX, textStartY, textSize.width, textSize.height) withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:nameTextFont],NSForegroundColorAttributeName:color,NSParagraphStyleAttributeName:paragraph}];
